# user mailer (sends email on recieving contact message and when signing up)
class UserMailer < ApplicationMailer
  ...
  def welcome(client_name, client_email)
    @message = "#{client_name}, you have successfully signed up to H-ASH Store
                <br>
                <br>
                Have a nice day :D"
    mail(
      from: 'H.ASH.shop@outlook.com',
      to: client_email,
